...
# from mmcls.models.backbones.resnet import ResNet, ResLayer, Bottleneck
from projects.models.xresnet import XResNet, ResLayer, Bottleneck
...
class SEDAResNet(XResNet):
    ...
    def __init__(self, depth, se_ratio=16, **kwargs):
        ...
        super(SEDAResNet, self).__init__(depth, **kwargs)

    def make_res_layer(self, **kwargs):
        origin_res_layer = ResLayer(se_ratio=self.se_ratio, **kwargs)
        new_res_layer = origin_res_layer
        return new_res_layer
